...
public class StaticAnalysisDataManagementEditPage extends BasePage {
    ...
    public StaticAnalysisDataManagementEditPage(PageParameters parameters) {
        super(parameters);
    ...
    private void save(AjaxRequestTarget target, PageParameters parameters) {
        ...
        setResponsePage(
            StaticAnalysisDataManagementPage.class,
            parameters);
    }
    ...
    private boolean saveTableEntity() {
        ...
        sonarService.create(tableEntity);
     ...
     * @return
     */
    private Link<StaticAnalysisDataManagementPage> newCancelLink(final PageParameters parameters) {
        return new Link<StaticAnalysisDataManagementPage>("cancel") {
            private static final long serialVersionUID = -310533532532643267L;

            @Override
            public void onClick() {
                setResponsePage(StaticAnalysisDataManagementPage.class,parameters);
            }
        };
    }
}
