...
public class QMQualityIndicatorFormValidator extends AbstractFormValidator {
	...
	/** form components to be validated. */
   	...
   	public QMQualityIndicatorFormValidator(FormComponent f1, FormComponent f2, FormComponent f3) {
  		if (f1 == null) {
